...
class BadgeServiceTest {
  ...
  void getAll_returnsRepositoryValues() {
    List<Badge> expected =
        List.of(
            new Badge("David Gogging's badge", "David Gogging's badge from David Gogging's challenge"),
            new Badge("Impossible push up badge", "Impossible push up badge badge from Impossible push up badge challenge"));
